...
val mulMon = new Monoid[Int] {
  ...
  \end{lstlisting}
  \end{block}
  Monoid \alert{instances} are first class citizens
...
\begin{frame} \frametitle{LARGER USE CASES}
  ...
  \note{
    ...
    dereita, evaluar as operacoes na sub-arbore vermelha num thread, e a azul
    ...
    monoides sao asociativos, entao temos que combinar o resultado da arbore
    vermelha, a izquerda e a azul a direita cuando os combinamos com bullet.
  }
\end{frame}
...
object Parallel {
  ...
  \note {
    ...
    Se olham a documentacao do scala, o metodo fold mala isso que esta ai
...
%          \item explain we are in a functional context, nothing has sideeffects
%   \end{itemize}
% \end{frame}
