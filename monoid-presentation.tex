...
\begin{frame}{What is Abstraction?}
  \begin{quote}
...
has \alert{wider applications.}\\[2pt] \rightline{{\rm --- Wikipedia}}
  ...
  \begin{quote}
Being abstract is something profoundly different from being vague...The purpose of abstraction is not to be vague, but to create a \alert{new semantic level} in which one can be \alert{absolutely precise.}
\\[2pt] \rightline{{\rm --- E. W. Dijkstra}}
    \end{quote}
\end{frame}
