...
\begin{frame} \frametitle{OUTLINE}
  \begin{columns}[c]
    \column{0.6\textwidth}
      \tableofcontents
    \column{0.4\textwidth}
      \rotatebox{45}{\Large \usebeamercolor[fg]{structure}{\fbox{\texttt{There will be quizzes}}}}
  \end{columns}
  \begin{block}{}
    \centering
...
\begin{frame}\frametitle{EXAMPLES OF MONOIDS IN MATH}
  \begin{itemize}
    \item Integers under addition with zero identity.
      \[
      a + b \in \mathbb{Z} \qquad (a + b) + c = a + (b + c) \qquad a + 0 = 0 + a = a
      \]
    \item Integers under multiplication with 1 identity.
      \[
        a \cdot b \in \mathbb{Z} \qquad (a\cdot b)\cdot c = a\cdot (b\cdot c) \qquad a \cdot 1 = 1 \cdot a = a\]
    \item Subsets of \(\mathcal{U}\) under union with empty identity.
      \[
        \mathcal
        \mathcal{A} \cup \mathcal{B} \in \mathcal{P}(\mathcal{U}) \qquad
...
\begin{frame} \frametitle{LARGER USE CASES}
  ...
  \begin{block}{The Problem}
    \begin{itemize}
      ...
      \item The operation \(\bullet\) is expensive.
      \item Example: combining rendered images
      \item Obvious solution: \texttt{mconcat(List(a1, a2, ..., an))}
    \end{itemize}
  \end{block}
...
\begin{frame} \frametitle{CONCLUSIONS}
  \begin{itemize}
    ...
    \item Only write \alert{lawful} Monoids.
    ...
    \column{0.7\textwidth}
      \begin{itemize}
        ...
        \item This talk: slides, all the \alert{code and many tests} \\
          \href{https://github.com/paraseba/scaladores-may-2018-talk}{\underline{https://github.com/paraseba/scaladores-may-2018-talk}} % fixme
